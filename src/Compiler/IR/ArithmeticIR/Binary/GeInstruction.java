 ...
 */
public class GeInstruction extends BinaryInstruction {
    public GeInstruction(VRegister target, Operand source1, Operand suorce2) {
    ...
    public static Instruction getInstruction(Operand target, Operand source1, Operand source2) {
        if (target instanceof VRegister) {
            return new GeInstruction((VRegister)target, source1, source2).update();
        }
        throw new Error();
    }
