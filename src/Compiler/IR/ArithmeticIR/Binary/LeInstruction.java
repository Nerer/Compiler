 ...
 */
public class LeInstruction extends BinaryInstruction{
    public LeInstruction(VRegister target, Operand source1, Operand suorce2) {
    ...
    public static Instruction getInstruction(Operand target, Operand source1, Operand source2) {
        if (target instanceof VRegister) {
            return new LeInstruction((VRegister)target, source1, source2).update();
        }
        throw new Error();
    }
